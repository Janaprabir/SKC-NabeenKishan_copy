...
class _HomePageState extends State<HomePageManager> {
  ...
  bool _isInsertActivityActive = false;
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.wifi, color: Colors.green, size: 40),
                ),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      child: const Text('Stay Offline', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                    ),
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                      ...
                      onPressed: () {
                        setState(() {
                          ...
                          _isInsertActivityActive = true;
                        });
                        Navigator.pop(context);
                        _loadData(checkAttendance: true);
                      },
                      child: const Text('Go Online', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                    ),
                  ],
                ),
              ],
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Offline Mode', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                    ),
                  ],
                ),
              ],
  ...
  Future<void> _fetchProfilePicture() async {
    ...
    try {
      final url = Uri.parse(
          'https://www.skcinfotech.net.in/nabeenkishan/api/routes/EmployeeController/getEmployeeDetails.php?emp_id=$_empId');
  ...
  Future<void> _checkAttendanceStatus() async {
    ...
    try {
      ...
      final url = Uri.parse(
          'https://www.skcinfotech.net.in/nabeenkishan/api/routes/AttendanceController/attendanceReport.php'
      ...
      setState(() {
        if (jsonResponse['message'].contains('successfully')) {
          ...
          if (attendanceData['out_time'] == '00:00:00' || attendanceData['out_time'] == '') {
            _isInTimeActive = false;
  ...
  Future<void> _recordInAttendance(String type) async {
    ...
    await Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ManagerAttendancePage()),
    );
    _loadData(checkAttendance: true);
  }

  void _navigateToRoute(String route) {
    if (route != 'insert_activity' && route != 'pending_activities' && (_isOfflineMode || !_isNetworkConnected)) {
      if (!_isOfflineMode) _showNetworkErrorDialog();
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Manager Dashboard${_isOfflineMode ? ' (Offline)' : ''}',
        ...
        actions: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: Colors.green.withOpacity(_isNetworkConnected && !_isOfflineMode ? 0.3 : 0.15),
                  blurRadius: 8,
            ...
            child: IconButton(
              icon: CircleAvatar(
                ...
                backgroundColor: Colors.grey[300]!.withOpacity(_isNetworkConnected && !_isOfflineMode ? 1.0 : 0.5),
                backgroundImage: _profileImageUrl != null ? NetworkImage(_profileImageUrl!) : null,
                child: _profileImageUrl == null
                    ? Icon(
                        Icons.person_outline,
                        color: Colors.black87.withOpacity(_isNetworkConnected && !_isOfflineMode ? 1.0 : 0.5),
                        size: 28,
                      )
                    : null,
              ),
              onPressed: (_isNetworkConnected && !_isOfflineMode)
                  ? () => Navigator.pushNamed(context, 'profile').then((_) => _loadData(checkAttendance: false))
                  : null,
            ),
          ),
        ],
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              _isOfflineMode ? 'Offline Mode' : 'Welcome, Manager!',
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 24,
                            ...
                            const SizedBox(height: 8),
                            Text(
                              _isOfflineMode ? 'Manage your activities offline' : 'Oversee your team\'s performance',
                              style: const TextStyle(
                      ...
                      Column(
                        children: [
                          _buildButton(
                            ...
                            icon: Icons.add_task,
                            route: 'insert_activity',
                            isActive: _isInsertActivityActive,
                          ),
                          const SizedBox(height: 16),
                          _buildButton(
                            context: context,
                          ...
                          _buildButton(
                            context: context,
                            title: 'PMD Approval Report',
                            icon: Icons.receipt_long,
                            route: 'cumulative_report',
                            isActive: _isNetworkConnected && !_isOfflineMode,
                          ),
                          const SizedBox(height: 16),
                          _buildButton(
        ...
        child: Row(
          children: [
            ...
            Icon(
              ...
              size: 18,
              color: Colors.grey.withOpacity(isActive ? 1.0 : 0.5),
            ),
          ],
        ),
      ),
