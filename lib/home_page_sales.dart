...
class _HomePageState extends State<HomePageSales> {
  ...
  bool _showExtraButtons = false; // New state variable for extra buttons
    ...
    try {
      ...
      if (_empId != null) {
        await Future.wait([
          ...
          _checkSubordinateTree(), // New API call to check subordinates
        ]);
      }
    } catch (e) {
                      ...
                      GridView.count(
                        ...
                        children: [
                          _buildButton(
                            ...
                            isActive:
                                _isDailyActivityActive && _isNetworkConnected,
                          ),
                          _buildButton(
                            context: context,
